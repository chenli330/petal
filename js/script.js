$(document).ready(function () {
    ...
    $('.navigation area').hover(function () {
        ...
        if (n == 'logo') {
            ...
            $('#nav' + n + '> img').css({zIndex: 8}).stop().animate({
                width: 165,
                height: 177,
                left: 5,
                top: 5
    ...
    if ($.browser.msie && $.browser.version == 8) {
        ...
        $('.pagin a').click(function () {
            $(this).stop().css({
                ...
                fontWeight: 'bold',
                color: '#1b1b1b'
            }).siblings().css({fontWeight: 'normal'}).stop().animate({color: '#1b1b1b', backgroundColor: '#ececec'})
        })
        ...
        actFu: function (_) {
            if (_.prev && _.curr) {
                ...
                _.prev.find('.pad').stop().animate({opacity: 0}, function () {
                    ...
                    _.prev.find('.bg_cont').stop().animate({
                        top: 303,
                        left: 281,
                        width: 0,
                        height: 0
                    }, 600, 'easeInBack', function () {
                        _.curr.find('.back').css({
                            top: 384,
                            left: 477,
                            opacity: 0,
                            display: 'block'
                        ...
                        _.curr.find('.bg_cont').stop().animate({
                            top: 0,
                            left: 0,
                            width: 562,
                            height: 606
                    ...
                    _.prev.find('.pad').stop().animate({opacity: 0}, function () {
                        ...
                        _.prev.find('.bg_cont').stop().animate({
                            ...
                            _.prev.find('.back').stop().animate({top: 212, left: 163}, 600, 'easeOutBack', function () {
                                ...
                                for (i = 0; i < num; i++) {
                                    var th = $('#menu > li').eq(i);
                                    th.stop().delay(220 * i).animate({
                                        top: th.data('top'),
                                        left: th.data('left')
                                    }, 600, 'easeOutBack')
                                    th.find(' > img').stop().delay(220 * i).animate({
                                        top: 15,
                                        left: 15,
                                        width: 145,
                                        height: 157
