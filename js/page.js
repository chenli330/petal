...
var createItem = function (text, name, time) {
    ...
    container.html("");
    $('<div class="item"><textarea rows="4" cols="15" style="overflow-x: hidden">&nbsp;&nbsp;&nbsp;&nbsp;' + text + '</textarea><p class="wishname">By&nbsp;&nbsp;&nbsp;&nbsp;' + name + '</p><p class="wishtime">' + time + '</p></div>').css({'background': color}).appendTo(container);
};
